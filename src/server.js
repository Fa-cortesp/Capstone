...
app.post('/register', (req, res) => {
    ...
    connection.query(query, values, (error, results) => {
        ...
        const id_rol = 5; // Asignar el valor por defecto de id_rol
        ...
        connection.query(insertQuery, [rut, primerNombre, segundoNombre || '', apellidoPaterno, apellidoMaterno, correo, telefono, direccion, password, id_rol, id_estadousuario], (err, result) => {
            ...
            res.status(201).json({ message: 'Registro exitoso' }); // Cambiar el estado a 201 para indicar creación exitosa
        });
    });
});
...
app.get('/api/roles', (req, res) => {
    const sql = 'SELECT * FROM rol'; // Asegúrate de que esta consulta sea correcta según tu base de datos
...
app.get('/api/estados', (req, res) => {
    const sql = 'SELECT * FROM estado_usuario'; // Asegúrate de que esta consulta sea correcta según tu base de datos
...
// Configura la ruta principal para servir el HTML
